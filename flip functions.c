...
void flip_white_stone_west(int row, int col)				//flip black stone >>>>> white stone
{
    ...
    printf("sum_w=%d\n", sum_w);							//checkiingggggggggggggggggggggg
...
void flip_white_stone_east(int row, int col)						//flip black stone to white stone
{
...
void flip_white_stone_south(int row, int col)						//flip black stone to white stone
{
...
void flip_white_stone_north(int row, int col)						//flip black stone to white stone
{
...
void flip_white_stone_NE(int row, int col)						//flip black stone to white stone
{
    ...
    for(north_east=0;north_east<N-row-1;north_east++){
    		if(gameboard[row-1-north_east][col+1+north_east] == 'O'){
            	sum_NE++	;											//count the number of flip stones ; NE
...
void flip_white_stone_NW(int row, int col)						//flip black stone to white stone
{
...
void flip_white_stone_SE(int row, int col)						//flip black stone to white stone
{
...
void flip_white_stone_SW(int row, int col)						//flip black stone to white stone
{
